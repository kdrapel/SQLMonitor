...
//#endif
                ...
                if (results != null)
                    this.Invoke(() => {
                        results.Tables.Cast<DataTable>().ForEach(t => {
                            ...
                            dataGrid.Location = new Point(0,
                                tpData.Controls.Cast<DataGridView>().Sum(c => c.Height + 6));
        ...
        private void SaveScript() {
            ...
            if (!string.IsNullOrEmpty(newFile)) {
                _fileName = newFile;
                Monitor.Instance.AddRecentObject(_server, _server.Database, _fileName, RecentObjectTypes.FilePath,
                    string.Empty);
