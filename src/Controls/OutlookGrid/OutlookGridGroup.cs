...
namespace Xnlab.SQLMon.Controls.OutlookGrid
{
    ...
    #endregion IOutlookGridGroup - declares the arrange/grouping interface here
    ...
    public class OutlookgGridDefaultGroup : IOutlookGridGroup {
        ...
        public virtual string Text {
            get {
                if (column == null)
                    return string.Format("Unbound group: {0} ({1})", Value,
                        itemCount == 1 ? "1 item" : itemCount + " items");
                return string.Format("{0}: {1} ({2})", column.HeaderText, Value,
                    itemCount == 1 ? "1 item" : itemCount + " items");
            }
            set => text = value;
        }
        ...
        #endregion IOutlookGridGroup Members
    }
    ...
    public class OutlookGridAlphabeticGroup : OutlookgGridDefaultGroup {
        ...
        public override string Text {
            get => string.Format("Alphabetic: {1} ({2})", column.HeaderText, Value,
                itemCount == 1 ? "1 item" : itemCount + " items");
            set => text = value;
        }
